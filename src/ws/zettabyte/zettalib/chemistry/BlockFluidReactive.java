package ws.zettabyte.zettalib.chemistry;
...
public class BlockFluidReactive extends BlockFluidClassicWS implements IReactionReceiver
{
    ...
    public BlockFluidReactive(Configuration config, String name, int defaultID, Fluid fluid)
    {
        super(config, name, defaultID, fluid);
        // TODO Auto-generated constructor stub
    }

    public BlockFluidReactive(Configuration config, String name, int defaultID, Material material, Fluid fluid)
    {
        super(config, name, defaultID, material, fluid);
        // TODO Auto-generated constructor stub
    }

    public BlockFluidReactive(Configuration config, String name, Material material, Fluid fluid)
    {
